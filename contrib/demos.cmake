...
#Simplest Demo
##############################
set(SOLOUD_DEMO_SIMPLEST_SOURCES ${SOLOUD_DEMO_DIRECTORY}/simplest/main.cpp)
add_executable(simplest ${SOLOUD_DEMO_SIMPLEST_SOURCES})
target_link_libraries(simplest PUBLIC soloud)


#set(SOLOUD_DEMO_CTEST_SOURCES ${SOLOUD_DEMO_DIRECTORY}/c_test/main.c)
#add_executable(ctest ${SOLOUD_DEMO_CTEST_SOURCES})
