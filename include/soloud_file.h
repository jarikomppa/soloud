...
namespace SoLoud
{
	...
	{
	public:
		unsigned int read_uint8();
		unsigned int read_uint16();
	...
	public:
		...
		~MemoryFile();
		MemoryFile();
		result open(unsigned char *aData, unsigned int aDataLength, bool aCopy=false, bool aTakeOwnership=true);
		result open(File *aFile);
	};
};
