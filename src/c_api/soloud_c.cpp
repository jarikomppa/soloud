...
void TinyAlignedFloatBuffer_destroy(void * aClassPtr)
{
  delete (TinyAlignedFloatBuffer *)aClassPtr;
}

void * TinyAlignedFloatBuffer_create()
{
  return (void *)new TinyAlignedFloatBuffer;
}
