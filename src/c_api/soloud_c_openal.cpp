...
{
	return openal_init(aSoloud);
}

int Soloud_openal_initEx(Soloud * aSoloud, int aFlags, int aSamplerate, int aBuffer)
{
	return openal_init(aSoloud, aFlags, aSamplerate, aBuffer);
}
