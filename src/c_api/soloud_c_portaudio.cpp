...
{
	return portaudio_init(aSoloud);
}

int Soloud_portaudio_initEx(Soloud * aSoloud, int aFlags, int aSamplerate, int aBuffer)
{
	return portaudio_init(aSoloud, aFlags, aSamplerate, aBuffer);
}
