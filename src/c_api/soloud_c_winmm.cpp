...
{
	return winmm_init(aSoloud);
}

int Soloud_winmm_initEx(Soloud * aSoloud, int aFlags, int aSamplerate, int aBuffer)
{
	return winmm_init(aSoloud, aFlags, aSamplerate, aBuffer);
}
