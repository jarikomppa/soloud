...
{
	return xaudio2_init(aSoloud);
}

int Soloud_xaudio2_initEx(Soloud * aSoloud, int aFlags, int aSamplerate, int aBuffer)
{
	return xaudio2_init(aSoloud, aFlags, aSamplerate, aBuffer);
}
